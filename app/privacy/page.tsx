...
export default function PrivacyPage() {
  return <LegalPage eyebrow="Your memories, explained clearly" title="Privacy Policy" updated="August 9, 2026">
    ...
    <aside><strong>The short version:</strong> your journal starts on your device. iCloud sync is optional. AI recaps run only when you request them and send the relevant memories through Lately’s secure recap service to Google Gemini. We do not sell your personal information.</aside>
    ...
    <h2>3. Optional AI recaps</h2><p>Lately can create month and year recaps using Google Gemini. This feature runs only when you request a recap. To provide it, the app sends the dates, prompts and journal text from memories in the requested month or year, together with a limited number of photos attached to those memories, to Lately’s secure recap service at api.uselately.app. The service verifies your anonymous RevenueCat app-user identifier and active entitlement, applies abuse-prevention limits, and forwards the recap content to Google’s Gemini API. Doodle drawing data is not sent, and memories from other months or years are not included. The recap service does not intentionally store journal content, photos or generated recap text after completing the request. Its infrastructure may temporarily process network information such as an IP address and request timing for security, delivery and diagnostics; application error logs do not include journal content. Google processes the submitted content to return generated recap text. Do not include information you do not want processed by an AI provider. AI output can be inaccurate and should not be treated as professional advice.</p>
    ...
    <h2>7. Service providers</h2><p>Information is shared only as necessary with Apple (App Store, speech recognition, notifications and iCloud), Google (Gemini API for requested recaps), RevenueCat (purchase and entitlement management), and the infrastructure providers that host and protect api.uselately.app. Their processing is governed by their own terms and privacy policies.</p>

    <h2>8. Retention and deletion</h2><p>Local journal content remains until you delete the memory, clear app data or remove the app. iCloud copies remain according to your iCloud settings and Lately’s bounded synchronization process. Lately’s recap service processes journal content, selected photos and generated text transiently for the requested recap and does not intentionally retain that content after the request completes. Short-lived security and diagnostic records may contain request metadata but not journal content. Purchase records may be retained by Apple and RevenueCat as required for transaction, fraud-prevention and legal purposes. To request deletion of support information held directly by us, contact us at the address below.</p>
    ...
    <h2>12. Children</h2><p>Lately is not directed to children under 13, and we do not knowingly collect personal information from children under 13. The optional AI recap feature is available only to users who are at least 18 years old. If you believe a child has provided information to us, contact us.</p>
